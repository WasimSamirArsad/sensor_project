...
class TrainingPipeline:
    ...
    def run_pipeline(self):
        try:
            ...
            train_arr,test_arr,Prepressor_path=self.start_data_transformation(feature_store_file_path)
            r2score=self.start_model_training(train_arr,test_arr)
            
            print("training completed , trained model score ",r2score)
        except Exception as e:
            raise CustomException(e,sys)
